...
import com.example.quacksbag.ai.strategy.flask.UseFlaskByProbabilityStrategy;
...
public class FlaskStrategyFactory {
    public static FlaskStrategy createStrategy(FlaskStrategyOptionWrapper options) {
        return switch (options.getOption()) {
            ...
            case USE_FLASK_BY_PROBABILITY ->
                    new UseFlaskByProbabilityStrategy(options.getPropability());
        };
    }
}
